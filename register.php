...
if (isset($_POST[$MM_flag])) {
  ...
  $LoginRS__query = sprintf("SELECT username FROM userinfo WHERE username=%s or email=%s", GetSQLValueString($loginUsername, "text"),
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO userinfo (username, password, FirstName, LastName, email,AccessLevel,Division,DateRegister) VALUES (%s, %s, %s, %s, %s,'2',%s,'$date')",
 ...
 echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert('Register for new Staff success.')
...
<body>
<h1 align="center">Register New Staff.</h1>
<p>&nbsp;</p>
<p>&nbsp;</p>
    ...
    <table width="474" height="286" border="0">
      ...
      <tr>
        ...
        <td><div align="center"><span id="sprytextfield6">
          ...
          <span class="textfieldRequiredMsg">A value is required.</span></span></div>          <span id="sprytextfield3">
      ...
      <tr>
        ...
        <td><div align="center"><span id="sprypassword3">
          ...
          <span class="passwordRequiredMsg">A value is required.</span></span></div>          <span id="sprypassword1">
          <label for="password"></label>
          <div align="center"></div>
        </span></td>
      </tr>
      <tr>
        <td><div align="center">Confirm Password<span id="sprytextfield4">
        </span></div>          <span id="sprytextfield4">
        ...
        <td><div align="center"><span id="spryconfirm1">
          ...
          <span class="confirmRequiredMsg">A value is required.</span><span class="confirmInvalidMsg">The values don't match.</span></span></div>          <span id="sprypassword2">
      ...
      <tr>
        ...
        <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></div>          <span id="sprytextfield5">
          <label for="email"></label>
          <div align="center"></div>
        </span></td>
      </tr>
