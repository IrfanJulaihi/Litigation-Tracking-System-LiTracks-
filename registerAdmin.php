...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="UsernameAvailableAdmin.php";
...
echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert('Register for new ADMIN success.')
...
<body>
<h1 align="center">Register New Admin.</h1>
<p>&nbsp;</p>
<p>&nbsp;</p>
  ...
  <div align="center">
    ...
    <table width="474" height="286" border="0">
      <tr>
        ...
        <th scope="col"><label for="ussername2"></label>
      ...
      <tr>
        ...
        <td><div align="center"><span id="sprytextfield8">
          ...
          <input name="AccessLevel" style="text-align:center;"  type="hidden" id="AccessLevel" value="1" readonly="readonly"/>
        <span class="textfieldRequiredMsg">A value is required.</span></span></div></td>
      </tr>
      <tr>
        <td><div align="center"></div></td>
