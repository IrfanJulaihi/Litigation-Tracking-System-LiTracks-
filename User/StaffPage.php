...
<p align="center" style="font-size: 20px; position: absolute; top: 12px; left: 1064px; height: 44px; width: 247px;">You logged in as Staff</p>
<h1 align="center">Litigation Tracking Records</h1>
<p align="left">Welcome,<?php echo $_SESSION['MM_Username']?><span style="font-size:24px;"></span></p>
...
<form action="searchstatementGuest.php" method="post">
  <p>
...
<table  border="1" align="center" cellpadding="2" cellspacing="0" class="tableDesign">
  <tr >
    ...
    <td width="123"><div align="center"><strong>Status</strong></div></td>
  </tr>
  <?php do { ?>
  <tr>
