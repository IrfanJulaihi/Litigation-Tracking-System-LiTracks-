...
<h1><img src="01_sedc_logo (1).gif" width="175" height="67"></h1>
<p align="center" style="font-size: 20px; position: absolute; top: 12px; left: 1064px; height: 44px; width: 247px;">You logged in as Maintenance</p>
<h1 align="center">Litigation Tracking Records</h1>
<p>&nbsp;</p>

<ul id="MenuBar1" class="MenuBarHorizontal">
  <li><a href="userManualStaff.php">User Manual</a></li>
  <li><a href="#" class="MenuBarItemSubmenu" onClick="window.print()">Record Action</a>
    <ul>
...
<form action="searchdebtorsMain.php" method="post">
  <p>
...
<form action="searchnatureMain.php" method="post">
  <p>
...
<form action="searchstatementMain.php" method="post">
  <p>
...
<form action="searchstatusMain.php" method="post">
  <p>
...
<table  border="1" align="center" cellpadding="2" cellspacing="0" class="tableDesign">
  <tr >
    <td width="100" height="52"><div align="center"><strong>ID</strong></div></td>
    <td width="135"><div align="center"><strong>Debtors</strong></div></td>
    <td width="126"><div align="center"><strong>Nature of Claim</strong></div></td>
    <td width="146" nowrap="nowrap"><div align="center"><strong>Statement</strong></div></td>
    <td width="123"><strong>Status</strong></td>
    <td width="123"><div align="center"><strong>Modify</strong></div></td>
  </tr>
  <?php do { ?>
  <tr height="50">
    ...
    <td><a href="delete.php?id=<?php echo $row_Recordset2['id']; ?>">
      </a><a href="edit.php?id=<?php echo $row_Recordset2['id']; ?>">
      <input type="submit" name="button" id="button2" value="Edit">
      </a><a href="delete.php?id=<?php echo $row_Recordset2['id']; ?>">
