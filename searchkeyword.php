...
$_SESSION["SearchItem"]=$_POST['findKeyword'] ;
mysql_select_db($database_localhost, $localhost);
...
$totalRows_searching = $_POST['findKeyword'];
}
$colname_searching = "-1";
if (isset($_POST['findKeyword'])) {
...
$query_searching = sprintf("SELECT * FROM information WHERE Keyword LIKE %s ORDER BY id DESC", 
GetSQLValueString("%" . $colname_searching . "%", "text"));
$searching = mysql_query($query_searching, $localhost) or die(mysql_error());
$row_searching = mysql_fetch_assoc($searching);
...
$_SESSION['FindKeyword']=$_POST['findKeyword'];
?>
...
<body>
<h2>
  <form id="form1" name="form1" method="post" action="PrintAllSearchKeywords.php">
 ...
 <?php $no=1;?>
  <?php do { //dont change this?>
    <tr>
      ...
      </a><a href="PrintPage.php?id=<?php echo $row_searching['ID']; ?>">      </a></td>
    </tr>
