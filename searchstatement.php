...
$_SESSION["SearchItem"]=$_POST['findstatement'] ;
...
if($totalRows_searchStatement==0){
...
<table border="1" cellpadding="2" cellspacing="0">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a href="edit.php?id=<?php echo $row_searchStatement['ID']; ?>">
        <input type="submit" name="button2" id="button2" value="Edit" />
      </a></td>
      <td><a href="delete.php?id=<?php echo $row_searchStatement['ID']; ?>">
