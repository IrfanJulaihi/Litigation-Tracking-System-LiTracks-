...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "page3.php";
  $MM_redirectLoginFailed = "access_denied_guest.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_localhost, $localhost);
  
  $LoginRS__query=sprintf("SELECT username, password FROM readonlyinfo WHERE username=%s AND password=%s",
