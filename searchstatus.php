...
$_SESSION['FindStatus']=$_POST['findstatus'];
?>
...
<h2>
  <form id="form1" name="form1" method="post" action="PrintAllSearchStatus.php">
  <p id="PrintTitle">Please enter report header / title(e.g. &quot;Report as at 31 December 2015&quot;)
    <label for="PrintTitle3"></label>
...
<table border="1" cellpadding="2" cellspacing="0" class="CSSTableGenerator">
  ...
  <?php do { ?>
    <tr>
      ...
      </a><a href="edit.php?id=<?php echo $row_searchStatus['ID']; ?>">
      <input type="submit" name="button" id="button2" value="Edit" />
      </a><a href="delete.php?id=<?php echo $row_searchStatus['ID']; ?>">
