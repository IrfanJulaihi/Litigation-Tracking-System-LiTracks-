...
mysql_select_db($database_localhost, $localhost);
$query_Recordset1 = sprintf("SELECT * FROM information WHERE ID LIKE %s", GetSQLValueString("%" . $colname_Recordset1 . "%", "text"));
$Recordset1 = mysql_query($query_Recordset1, $localhost) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
...
<body>
<p><img src="SEDC Logo - Copy.png" width="249" height="210">
...
<ul id="MenuBar1" class="MenuBarHorizontal">
  <li><a href="#" class="MenuBarItemSubmenu">View List</a>
    <ul>
      <li><a href="listAdmin.php">View Members</a></li>
  ...
  <li><a class="MenuBarItemSubmenu" href="#">Register New user</a>
    <ul>
      <li><a href="registerAdmin.php">Admin User</a></li>
      <li><a href="register.php">Staff User</a></li>
      <li><a href="registerMaintenance.php">MaintenanceUser</a></li>
    </ul>
  </li>
  <li><a href="#" class="MenuBarItemSubmenu">Edit Account</a>
    <ul>
<li><a href="newAdminPass.php">Change Password</a></li>
    </ul>
  </li>
...
<form action="search.php" method="post">
  <p>
    ...
    <input type="submit" value="Search for Parties" id="buttonfind4">
  </p>
</form>

<form action="searchnature.php" method="post">
  <p>
    <input name="findnature" type="text" id="buttonfind5">
...
<table  border="1" align="center" cellpadding="2" cellspacing="0" class="CSSTableGenerator">
  <tr style="background-color:#960;" id="row1">
    ...
    <td width="115" >Keyword</td>
    <td width="115" ><div align="center">Date Modified</div></td>
    <td id="id1" ><div align="center"><strong>Modify</strong></div></td>
  </tr>
  <?php $no=1;?>
  <?php do { ?>
  <tr>
    ...
    <td width="37" id="id2"><a href="PrintPage.php?variable=<?php  echo  $DisplayNumberRow-1;?>,<?php  echo  $row_Recordset1['ID'];?>">
	<input type="submit" name="button" id="button2" value="Print" onclick="myFunction()" >
  </a>
...
<p style="position: absolute; left: 10px; top: 687px;"> There are <?php echo $totalRows_Recordset1  ?>  records found.</p>
...
<a href="page2.php?page=<?php echo $b-1?>" 
