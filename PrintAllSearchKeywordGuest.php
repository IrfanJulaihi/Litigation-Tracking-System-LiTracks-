...
$query_Recordset1 = sprintf("SELECT * FROM information WHERE Keyword LIKE %s ORDER BY ID DESC", 
GetSQLValueString("%" .$_SESSION['FindKeywordGuest'] . "%", "text"));
$Recordset1 = mysql_query($query_Recordset1, $localhost) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);
}else{
$query_Recordset1 = sprintf("SELECT * FROM information WHERE Keyword LIKE %s and Category Like %s ORDER BY ID DESC", GetSQLValueString("%" .$_SESSION['FindKeywordGuest'] . "%", "text"),
